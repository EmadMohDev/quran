                ...
                <div class="box box-black">
                    ...
                    <div class="box-content">
                        <div class="btn-toolbar pull-right">
                            <div class="btn-group">
                                <form action="{{ url('provider/multi/delete') }}" method="post" style="display: none">
                                    @csrf
                                    @method('delete')
...
<script>
        ...
        $('body').on('change', 'input.check-toggle', function (e) {
            ...
            $.ajax({
                url: '{{ url("toggle/field/") }}/'+field,
                type: "get",
                data: { id: id },
                success: function (data, textStatus, jqXHR) {
                    if (td.children().length > 1) {
                        td.find('span.badge').remove();
                        td.prepend(data);
                    }
                },
            });
