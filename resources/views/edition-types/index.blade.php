            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-black">
                        <div class="box-title">
                            <h3><i class="fa fa-table"></i> Edition Types Table </h3>
                            <div class="box-tool">
                        ...
                        <div class="box-content">
                            <div class="btn-toolbar pull-right">
                                <div class="btn-group">
                                    <form action="{{ url('edition-types/multi/delete') }}" method="post" style="display: none">
                                        @csrf
                                        @method('delete')
...
@section('script')
    <script>
        ...
        $('#edition-types-index').addClass('active');
    </script>
@stop
